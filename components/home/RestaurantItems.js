        ...
        <>
            {
                props.restaurantData.map((restaurant, index) => {
                    return (
                        <TouchableOpacity key={index} activeOpacity={1} style={{ marginBottom: 20 }} onPress={() => navigation.navigate('RestaurantDetail', {
                            ...
                            <View style={{ marginTop: 20, padding: 20, backgroundColor: 'white', borderRadius: 35 }}>
    ...
    return (
        <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginTop: 15 }}>
            ...
            <View style={{ backgroundColor: '#eee', height: 30, width: 30, alignItems: 'center', borderRadius: 15 }}>
                <Text style={{ lineHeight: 26 }}>{props.rating}</Text>
            </View>
        </View>
    )
}